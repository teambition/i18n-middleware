...
(function() {
  var I18nCli, I18nMiddleware, async, errorQuit, exec, findAllFiles, fs, i18nCli, logger, path, quote, _;
  ...
  I18nCli = (function() {
    ...
    I18nCli.prototype.format = function(revert) {
      var $revDict, dict, i, i18nMiddleware, k, lang, raws, revDict, srcs, textExts, v;
      if (revert == null) {
        revert = false;
      }
      lang = this.args[0];
    ...
    I18nCli.prototype.compile = function() {
      ...
      _ref = this.args, lang = _ref[0], directory = _ref[1], src = _ref[2], destDir = _ref[3], textExts = _ref[4];
      lang = lang || 'all';
      ...
      textExts = (textExts != null ? textExts.split(',') : void 0) || ['*.coffee', '*.html', '*.less'];
      options = {};
      options.force = true;
