...
(function() {
  ...
  I18nMiddleware = (function() {
    ...
    function I18nMiddleware(options) {
      ...
      var f, langFiles;
      this.options = _.extend(_.clone(I18nMiddleware.defaultOptions), options || {});
    ...
    I18nMiddleware.prototype.__ = function(param, value) {
      var locale, phrase, _ref, _replace;
      phrase = param.phrase, locale = param.locale;
      _replace = function(phraseVal) {
        var i;
        if (phraseVal == null) {
          return phraseVal;
        }
        switch (typeof value) {
          ...
          case 'object':
            if ((value.length != null) && value.length > 0) {
              i = -1;
              return phraseVal.replace(/\%s/g, function() {
                i += 1;
                return value[i] || '';
              });
            }
      ...
      if (this.dicts[locale] != null) {
        return _replace(this.dicts[locale][phrase]);
      }
      return _replace((_ref = this.dicts[this.options.defaultLocale]) != null ? _ref[phrase] : void 0);
    };
