...
(function() {
  ...
  I18nMiddleware = (function() {
    ...
    I18nMiddleware.prototype._guessLanguage = function(req, res, next) {
      var languageHeader, languages,
        _this = this;
      ...
      if (languageHeader != null) {
        languageHeader.split(',').every(function(l) {
          ...
          if (__indexOf.call(_this.options.locales, lang) >= 0) {
            _this.options.defaultLocale = lang;
            return false;
          }
    ...
    I18nMiddleware.prototype.middleware = function() {
      ...
      _middleware = function(req, res, next) {
        return i18n.init(req, res, function() {
          return _this._guessLanguage(req, res, function() {
            var lang, matches, pathname, tmpPath;
            lang = i18n.getLocale(req);
            lang = __indexOf.call(options.locales, lang) >= 0 ? lang : _this.options.defaultLocale;
            lang = lang || 'en';
